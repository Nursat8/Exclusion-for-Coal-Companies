...
def main():
    ...
    if uploaded_file:
        ...
        if st.sidebar.button("Run"):
            filtered_df = filter_companies(df, selected_sectors, 5.0, 20.0, services_rev_threshold, 20.0, 10.0, 10000.0,
                                           True, True, exclude_services,
                                           True, True, True, True, True, exclude_services_rev,
                                           column_mapping)
